 ...
 *
 * This model handles all database operations related to catalogues.
 * It manages creating, updating, and fetching catalogue data.
 */
class CatalogueModel extends Model
{
    protected $table = 'Catalogue1'; // TODO: Consider a more descriptive table name
    ...
    /**
     * Inserts new catalogue data from a request.
     *
    ...
    public function data_insert($request)
    {
        ...
        $session->setFlashdata('error', 'Failed to insert catalogue data. Title, Author, and File are required.');
        return false;
    }
     ...
     *
     * @return array An array of pending catalogue records.
     */
    ...
    /**
     * Approves a catalogue record.
     *
     * @param int $id           The ID of the catalogue record.
    ...
    /**
     * Approves a catalogue record at the cataloguer level.
     *
     * @param int $id           The ID of the catalogue record.
    ...
    /**
     * Rejects a catalogue record at the cataloguer level.
     *
     * @param int $id           The ID of the catalogue record.
