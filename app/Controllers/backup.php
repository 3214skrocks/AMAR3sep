	...
	<div class="mt-4" id="b-inner-sec">
		<div class="container bg-light py-4 b-dbcard">
			...
			<!--Page Content-->
				...
				<div class="mt-3">
				<div class="titbg"><img style="width:100%;height:120pt" src="<?=base_url(); ?>public/assets/images/1.png"></img></div>
				...
				<div class="tab-content">
					...
					<!--Manscript Table-->
						<div class="table-responsive">
							<?php //print_r($manuscript_data); die(); ?>
										...
										<div class="col-md-6 col-lg-2 col-xlg-3">
											...
											<div class="card card-hover">
												<div class="box bg-success text-center">
													...
													<h6 class="text-white">Ayurveda- <?= $sys_count_ayurveda;?> </h6>
												</div>
											</div>
											</a>
										</div>
										...
										<div class="col-md-6 col-lg-2 col-xlg-3">
											<div class="card card-hover">
												<div class="box bg-secondary text-center">
													<h1 class="font-light text-white"><i class="fas fa-file-medical"></i></h1>
													<h6 class="text-white">Naturopathy-<?= $sys_count_naturopathy;?></h6>
												</div>
											</div>
										</div>
										<!--Count for Unani-->
										...
										<div class="col-md-6 col-lg-2 col-xlg-3">
											<div class="card card-hover">
												<div class="box bg-info text-center">
													<h1 class="font-light text-white"><i class="fas fa-file-medical"></i></h1>
													<h6 class="text-white">Homoeopathy- <?= $sys_count_homoeopathy;?></h6>
												</div>
											</div>
										</div>
