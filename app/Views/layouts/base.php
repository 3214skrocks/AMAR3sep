...
<html lang="en">
<head>
	<title>AMAR-Ayush Manuscripts Advanced Repository</title>
	<meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
	
	<!-- Favicons -->
    <link href="<?=base_url(); ?>/public/assets/images/logo.png" rel="icon">
	
    <link rel="stylesheet" href="<?=base_url(); ?>/public/assets/vendor/bootstrap/css/bootstrap.min.css" />
    <!-- Custom styles for this template -->
    <link rel="stylesheet" href="<?=base_url(); ?>/public/assets/css/base.css"/>
    <link rel="stylesheet" href="<?=base_url(); ?>/public/assets/css/base-responsive.css" />
    ...
    <link rel="stylesheet" href="<?=base_url(); ?>/public/assets/vendor/OwlCarousel/css/owl.carousel.min.css">
...
<body class="">
	...
	<div class="container d-flex clearfix" id="b-accessibility">
		<div class="b-ministryname">
			<div class="text-right d-inline-block font-weight-bold b-acc-goi my-sm-1 pr-sm-2">
				<span class="sub-head">भारत सरकार</span> <br> <span class="sub-head">GOVERNMENT OF INDIA</span>
			</div>

			<div class="font-weight-bold d-inline-block b-acc-ministry my-sm-1 pl-sm-1">
				<span class="sub-head">आयुष मंत्रालय</span> <br> <span class="sub-head">Ministry of Ayush</span>
			</div>
		</div>
	...
	<div class="container clearfix" id="b-header">
		<div class="float-left d-flex h-100">
			<img src="<?=base_url(); ?>/public/assets/images/ccras_logo.png" class="align-self-center b-emblem-image" title="National Emblem of India" alt="emblem of india logo">
		</div>

		<div class="float-left d-flex h-100">
			<strong class="align-self-center pl-3">
				<!--<span>आयुष पाण्डुलिपि उन्नत भंडार</span> <br>-->
				<span class="title">AMAR-Ayush Manuscripts Advanced Repository </span><br>
				<span class="sub-title">CCRAS-National Institute of Indian Medical Heritage</span>
			</strong>
		</div>
	</div>
	</div>
			...
			<nav class="navbar navbar-expand-sm navbar-dark px-0">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					<ul class="navbar-nav main-menu d-flex">
						<li class="nav-item d-block"> <a href="<?=base_url(); ?>" class="nav-link active">Home</a> </li>
						<li class="nav-item d-block"> <a href="<?=base_url(); ?>about" class="nav-link">About Us</a></li>
						<div class="dropdown nav-item">
						  <li class="nav-item d-block" data-bs-toggle="dropdown"> <a href="#" class="nav-link dropdown-toggle">Repository</a></li>
						  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						    <a class="dropdown-item" href="<?=base_url(); ?>manuscript">Manuscript</a>
						    <a class="dropdown-item" href="<?=base_url(); ?>rarebook">RareBooks</a>
						    <a class="dropdown-item" href="<?=base_url(); ?>catalogue">Catalogue</a>
							<a class="dropdown-item" href="<?=base_url(); ?>periodicals">Periodicals</a>
						  </div>
						</div>
						
						<!--<li class="nav-item d-block"> <a href="manuscript.php" class="nav-link">Manuscript</a></li>-->
						<li class="nav-item d-block"> <a href="contact" class="nav-link">Contact Us</a></li>
						<li class="nav-item d-block"> <a href="<?=base_url(); ?>admin/login" class="nav-link active">Login</a> </li>
...
<hr>
	...
	<!-- Footer Logos -->
	<!-- <div class="footer-carousal">
		<div class="container">
			<div class="f-logo active">
				<img src="images/carousel/digital-india.png" alt="">
			</div>
			<div class="f-logo">
				<img src="images/carousel/data-gov.png" alt="">
			</div>
			<div class="f-logo">
	            <img src="images/carousel/eci.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/e-gazette.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/ganhri.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/goidirectory.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/incredible-india.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/india-gov.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/makeinindia.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/mygov.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/myvisit-logo.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/pg-portal.png" alt="">
	        </div>
	        <div class="f-logo">
	            <img src="images/carousel/pmnrf.png" alt="">
	        </div>
		</div>
	</div> -->
	...
	<div class="footer-bs">
	    <footer class="container">
	        <div class="row">
	        	...
	        	<div class="col-md-3 col-sm-8 footer-social d-flex">
        			<div class="d-inline-block align-self-center">
	        			<p class="bg-light"><img src="<?=base_url(); ?>/public/assets/images/NIC.png" alt="NIC logo"></p>
	        			<p class="bg-light mb-0"><img src="<?=base_url(); ?>/public/assets/images/digital-india.png" alt="digital india logo"></p>
	        		</div>
	            </div>
			...
			<hr>
	        <div class="text-center mt-12 globalnav-bg-menu">
	        	Website Content,Design and Developed by <a class="text-light font-weight-bold" href="http://niimh.nic.in">CCRAS-National Institute of Indian Medical Heritage (NIIMH)</a>, <a class="text-light font-weight-bold" href="https://meity.gov.in/">Ministry of Ayush</a>, <a class="text-light font-weight-bold" href="https://www.india.gov.in/">Govt. of India.</a>
	        </div>
	    </footer>
	</div>
...
<!-- <br><br><br><br><br><br><br><br><br> -->
  ...
  <script src="<?=base_url(); ?>/public/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
  <script src="<?=base_url(); ?>/public/assets/js/jquery.slicknav.min.js"></script>
  <script src="<?=base_url(); ?>/public/assets/vendor/OwlCarousel/js/owl.carousel.min.js"></script>
  ...
  <script>
	...
	<script>
    	var owl = $('.owl-carousel.footer-logos');
			owl.owlCarousel({
			    items:5,
			    center: true,
			    nav: true,
			...
			var owlimg = $('.owl-carousel.img-gallery');
			owlimg.owlCarousel({
			    items:1,
			    stagePadding: 100,
			    center: true,
...
<!-- Bootstrap table 4 start -->
		<link rel = "stylesheet" href = "<?=base_url(); ?>/public/assets/vendor/datatables/css/dataTables.bootstrap4.min.css">
		<script src = "<?=base_url(); ?>/public/assets/vendor/datatables/js/jquery.dataTables.min.js"></script>
